...
import { decodeAgentIdFromQrImage, isQrScanSupported } from "../../../lib/decodeAgentQr";
...
export function WizardStepAgent({ agentId, onAgentIdChange, error }: WizardStepAgentProps) {
